...
void sp3_paint1(const nVECTOR &Vector0, const nVECTOR &Vector1, const nVECTOR &Vector2, const nVECTOR &Vector3,
                nVECTOR &Vector4, const float &BondLenth_04) {
...
void
sp3_paint2(const nVECTOR &Vector0, const nVECTOR &Vector1, const nVECTOR &Vector2, nVECTOR &Vector3, nVECTOR &Vector4,
           const float &BondLenth_03, const float &BondAngle_304) {
...
void
sp3_paint3(const nVECTOR &Vector0, const nVECTOR &Vector1, const nVECTOR &Vector2, nVECTOR &Vector3, nVECTOR &Vector4,
           nVECTOR &Vector5, const float &BondLenth_03, const float &BondAngle_103, const float &TorsionAngle_3012) {
...
void sp2_paint1(const nVECTOR &Vector0, const nVECTOR &Vector1, const nVECTOR &Vector2, nVECTOR &Vector3,
                const float &BondLenth_03) {
...
void
sp2_paint2(const nVECTOR &Vector0, const nVECTOR &Vector1, const nVECTOR &Vector2, nVECTOR &Vector3, nVECTOR &Vector4,
           const float &BondLenth_03, const float &BondAngle_103, const float &TorsionAngle_3012) {
    nVECTOR normVector10, normVector12, normVector012, normVector01_012;
    float   theta, phi;
